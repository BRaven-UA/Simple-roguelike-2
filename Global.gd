...
var gui: GUI	# ссылку на себя добавит сам узел при инициализации
var tooltip: GUI_Tooltip
var world: GameWorld	# ссылку на себя добавит сам узел при инициализации
var player: Player	# ссылку на себя добавит сам узел при инициализации
